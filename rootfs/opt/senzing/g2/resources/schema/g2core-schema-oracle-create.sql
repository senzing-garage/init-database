...
CREATE TABLE LIB_UTYPE (UTYPE_CODE VARCHAR2(255) NOT NULL) ;
...
CREATE TABLE RES_ENT (RES_ENT_ID NUMBER NOT NULL, LOCKING_ID NUMBER NOT NULL, LAST_TOUCH_DT NUMBER, LOCK_DSRC_ACTION CHAR(1)) ;
...
CREATE TABLE RES_FEAT_STAT (LIB_FEAT_ID NUMBER NOT NULL, NUM_RES_ENT NUMBER(7) NOT NULL, NUM_RES_ENT_OOM NUMBER(7) NOT NULL, CANDIDATE_CAP_REACHED CHAR(1) DEFAULT 'N' NOT NULL, SCORING_CAP_REACHED CHAR(1) DEFAULT 'N' NOT NULL) ;
