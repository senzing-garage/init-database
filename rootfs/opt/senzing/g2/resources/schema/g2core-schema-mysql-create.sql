...
CREATE TABLE LIB_UTYPE (UTYPE_CODE VARCHAR(255) NOT NULL) ;
...
CREATE TABLE RES_ENT (RES_ENT_ID BIGINT NOT NULL, LOCKING_ID BIGINT NOT NULL, LAST_TOUCH_DT BIGINT, LOCK_DSRC_ACTION CHAR(1)) ;
...
CREATE TABLE RES_FEAT_STAT (LIB_FEAT_ID BIGINT NOT NULL, NUM_RES_ENT MEDIUMINT NOT NULL, NUM_RES_ENT_OOM MEDIUMINT NOT NULL, CANDIDATE_CAP_REACHED CHAR(1) DEFAULT 'N' NOT NULL, SCORING_CAP_REACHED CHAR(1) DEFAULT 'N' NOT NULL) ;
