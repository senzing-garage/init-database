...
var IdMessages = map[int]string{
	...
	3001: "File does not exist: %s [SENZING_TOOLS_ENGINE_CONFIGURATION_FILE]",
	3002: "Could not backup %s to %s",
	3003: "Could not copy %s to %s [SENZING_TOOLS_ENGINE_CONFIGURATION_FILE]",
