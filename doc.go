...
More information at https://github.com/senzing-garage/init-database
...
More information can be found in the [pkg/github.com/senzing-garage/init-database/examplepackage] documentation.
