...
More information at https://github.com/senzing/init-database
...
More information can be found in the [pkg/github.com/senzing/init-database/examplepackage] documentation.
...
Examples of use can be seen in the main_test.go files.
	...
	import (
	    ...
	    "github.com/senzing/init-database/examplepackage"
	    "github.com/senzing/init-database/anotherpackage"
	)
